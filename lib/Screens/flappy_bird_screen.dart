...
import 'package:echo_east_v2/util/responsive.dart';
...
void main() async {
  ...
  String backgroundImagePath = 'assets/images/flappy_background.jpg';
      ...
      body: SafeArea(
          child: Row(
            children: [
              ...
              Expanded(
                flex: 7,
                child: GameWidget(game: MyGame(context)), // Display MyGame here
              ),
              if (isDesktop)
                Expanded(
                  flex: 3,
...
class MyGame extends Game with TapDetector {
  ...
  Future<void> onLoad() async {
    ...
    greenPaint = Paint()..color = const Color(0xFF1AC500); // Green color
    const greenRectWidth = 75.0;
    const greenRectHeight = 1000.0;
  ...
  Future<void> resetScore() async {
    ...
    Navigator.of(context).pushReplacement(MaterialPageRoute(
      builder: (context) => const MainMenuScreen(backgroundImage: AssetImage('assets/images/flappy_background.jpg')),
    ));
  }
...
class MainMenuScreen extends StatefulWidget {
  ...
  const MainMenuScreen({super.key, required this.backgroundImage});
